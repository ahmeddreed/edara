    ...
    <div class="row mb-3">
        <div class="col-lg-12 mb-5 mx-auto">
            <div class="card shadow rounded bg">
                <div class="card-body mx-auto">
                    <h3 class="text-center text-light"> لوحة التحكم</h3>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-5 my-3 ">
            <div class="card shadow rounded bg"  style="width:15rem;height:15rem;">
                ...
                <div class="card-body mx-auto">
                    <a href="{{ route("rolesTable") }}" class="btn btn-light color text-center rounded">الصلاحيات</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-5 my-3 ">
            <div class="card shadow rounded bg"  style="width:15rem;height:15rem;">
                ...
                <div class="card-body mx-auto">
                    <a href="{{ route("staffTable") }}" class="btn btn-light color text-center rounded">موظفين</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-5 my-3 ">
            <div class="card shadow rounded bg"  style="width:15rem;height:15rem;">
                ...
                <div class="card-body mx-auto">
                    <a href="{{ route("customerTable") }}" class="btn btn-light color text-center rounded">العملاء</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-5 my-3 ">
            <div class="card shadow rounded bg"  style="width:15rem;height:15rem;">
                ...
                <div class="card-body mx-auto">
                    <a href="" class="btn btn-light color text-center rounded">معلومات النظام</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-5 my-3 ">
            <div class="card shadow rounded bg"  style="width:15rem;height:15rem;">
                ...
                <div class="card-body mx-auto">
                    <a  wire:click='logout' class="btn btn-light color text-center rounded">تسجيل الخروج</a>
                </div>
            </div>
        </div>
