    ...
    <div class="row my-5">
        ...
        <div class="col-lg-6 col-md-8 col-sm-12 mx-auto my-3">
            <div class="shadow card">
                <img  src="{{  asset("storage/MaterialImage/".$material->image) }}" style="width: 30rem;height: 27rem;" alt="" class="card-img-top h-100 w-100">
        ...
        <div class="col-lg-6 col-md-8 col-sm-12 my-3 mx-auto">
            <div class="shadow card">
                <div class="card-body color">
                    <h3 class="fw-bold">تفاصيل المنتج</h3>
                    <hr class="color">
                    <div class="row fw-bold fs-5">
                        <div class="col-lg-5 col-md-5 ">الاسم :</div>
                        <div class="col-lg-5 col-md-3 "> {{ $material->title }}</div>

                        <div class="col-lg-5 col-md-5 ">السعر :</div>
                        <div class="col-lg-5 col-md-3 "> {{ $material->price }}</div>

                        @if($material->ItemDetails()->count() > 0)
                            @foreach($material->ItemDetails() as $item)
                                <div class="col-lg-5 col-md-5 ">{{ $item->key }} :</div>
                                <div class="col-lg-5 col-md-3 "> {{ $item->value  }}</div>
                            @endforeach
                        @endif
                        ...
                        {{-- <h1>{{ $item->id."-".$material->category_id }}</h1> --}}
                            @if($material->id !== $item->id)
                                <div class="swiper-slide card" style="width: 18rem;">
                                    <img  src="{{ asset("storage/MaterialImage/".$item->image) }} " class="card-img-top w-100" alt="">
